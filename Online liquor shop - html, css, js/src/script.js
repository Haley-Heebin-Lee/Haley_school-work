...
window.onload = () => {
  ...
  main_sale = displaySoju(main_sale);
  main_sale = displayBeer(main_sale);
  main_sale = displayRW(main_sale);
  main_sale = displayOthers(main_sale);
  ...
  var footersoju = document.querySelector('#footersoju');
  footersoju.onclick = function() {
    var isExistmain = body.querySelectorAll('main');
    var second = isExistmain[1];
    if (second) main.removeChild(second);
  ...
  var footerbeer = document.querySelector('#footerbeer');
  footerbeer.onclick = function() {
    var isExistmain = body.querySelectorAll('main');
    var second = isExistmain[1];
    if (second) main.removeChild(second);
  ...
  var footerrw = document.querySelector('#footerrw');
  footerrw.onclick = function() {
    var isExistmain = body.querySelectorAll('main');
    var second = isExistmain[1];
    if (second) main.removeChild(second);
  ...
  var footerothers = document.querySelector('#footerothers');
  footerothers.onclick = function() {
    var isExistmain = body.querySelectorAll('main');
    var second = isExistmain[1];
    if (second) main.removeChild(second);
  ...
  var footercompany = document.querySelector('#footercompany');
  ...
  var footerlocation = document.querySelector('#footerlocation');
  ...
  footerlocation.onclick = function() {
    var isExistmain = body.querySelectorAll('main');
    var second = isExistmain[1];
    if (second) main.removeChild(second);
...
function loginF(main) {
  ...
  input2.id = 'password';
  input2.pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
  input2.placeholder = 'Enter at least 8 Characters of A lowercase and uppercase, A number';
...
function registerF(main) {
  ...
  label3.innerText="Full Name:";
  let input3 = document.createElement('input');
  input3.type="text";
  input3.name="name";
  input3.id="name";
  input3.autocomplete = "name";
  input3.placeholder = 'Your full name...';

  let label4 = document.createElement('label');
  label4.setAttribute('for', 'tel-mobile');
  label4.innerText="Mobile Phone:";
  let input4 = document.createElement('input');
  input4.type="tel";
  input4.name="tel-mobile";
  input4.id="tel-mobile";
  input4.autocomplete = "tel tel-local mobile";
  input4.placeholder = 'ex) 6471110000';

  let label5 = document.createElement('label');
  label5.setAttribute('for', 'birth-date');
  label5.innerText="Your Birth Date:";
  let input5 = document.createElement('input');
  input5.type="date";
  input5.name="birth-date";
  input5.id="birth-date";
  input5.autocomplete = "bday";

  let fieldset = document.createElement('fieldset');
  let legend = document.createElement('legend');
  legend.innerText="Home Address:";
  let label6 = document.createElement('label');
  label6.setAttribute('for', 'street-address');
  label6.innerText="Street Address:";
  let input6 = document.createElement('input');
  input6.type="text";
  input6.name="street-address";
  input6.id="street-address";
  input6.autocomplete = "street-address home";

  let label7 = document.createElement('label');
  label7.setAttribute('for', 'address-level2');
  label7.innerText="City:";
  let input7 = document.createElement('input');
  input7.type="text";
  input7.name="address-level2";
  input7.id="address-level2";
  input7.autocomplete = "address-level2 home";

  let label8 = document.createElement('label');
  label8.setAttribute('for', 'postal-code');
  label8.innerText="Postal Code:";
  let input8 = document.createElement('input');
  input8.type="text";
  input8.name="postal-code";
  input8.id="postal-code";
  input8.autocomplete = "postal-code home";
  ...
  h5.className="ref-warning";
  let span = document.createElement('span');
  span.className="warning";
  span.innerText="&#9888;";
  h5.appendChild(span);
  h5.appendChild(document.createTextNode("you must be"));
  let p = document.createElement('p');
  p.className="strong";
  p.innerText="19 years of age";
  h5.appendChild(p);
  h5.appendChild(document.createTextNode("to purchase alcohol."));
  ...
  a.href="#";
  a.id="login2";
  a.innerText="Already have an Account?";
  p2.appendChild(a);
  div2.appendChild(p2);
